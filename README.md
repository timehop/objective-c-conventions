 ...
 * Constructors should generally return [`instancetype`](http://clang.llvm.org/docs/LanguageExtensions.html#related-result-types) rather than `id`. A good explanation of why can be found [here](http://stackoverflow.com/a/14652187/1136611).
